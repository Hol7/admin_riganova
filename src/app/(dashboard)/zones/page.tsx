...
export default function ZonesPage() {
  ...
  const createMutation = useMutation({
    mutationFn: (data: ZoneForm) => zonesApi.createZone(data),
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: (zoneId: number) => zonesApi.deleteZone(zoneId),
    onSuccess: () => {
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="mt-4 sm:mt-0 bg-yellow-500 text-white px-6 py-3 rounded-xl font-montserrat font-semibold flex items-center hover:bg-yellow-600 transition-colors"
        >
                ...
                <div key={zone.id} className="bg-gray-50 rounded-xl p-4">
                  ...
                  <div className="flex space-x-2">
                    <button
                      onClick={() => handleEdit(zone)}
                      disabled={updateMutation.isPending}
                      className="flex-1 bg-blue-500 text-white px-4 py-2 rounded-xl font-montserrat font-semibold flex items-center justify-center hover:bg-blue-600 disabled:opacity-50"
                    >
                    ...
                    <button
                      onClick={() => handleDelete(zone.id)}
                      disabled={deleteMutation.isPending}
                      className="flex-1 bg-red-500 text-white px-4 py-2 rounded-xl font-montserrat font-semibold flex items-center justify-center hover:bg-red-600 disabled:opacity-50"
                    >
